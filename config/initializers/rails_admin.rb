# RailsAdmin config file. Generated on October 31, 2013 20:35
# See github.com/sferik/rails_admin for more informations
ADMIN_EMAILS= ['fernandoira@gmail.com']
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Template Tienda', 'Admin']
  ...
  # config.excluded_models = ['Category', 'Product', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Category', 'Product', 'User']
